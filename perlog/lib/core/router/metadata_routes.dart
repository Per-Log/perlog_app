    ...
    routes: [
      GoRoute(
        ...
        pageBuilder: (context, state) =>
            fadeTransitionPage(key: state.pageKey, child: const CalendarPage()),
      ),
      GoRoute(
        path: Routes.imageUpload,
        pageBuilder: (context, state) => fadeTransitionPage(
          key: state.pageKey,
          child: ImageUpload(args: state.extra as MetadataImageData?),
        ),
      ),
      GoRoute(
        ...
        pageBuilder: (context, state) => fadeTransitionPage(
          key: state.pageKey,
          child: ImageUploadEdit(args: state.extra as MetadataImageData?),
        ),
      ),
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) => fadeTransitionPage(
          key: state.pageKey,
          child: OCRLoading(args: state.extra as MetadataImageData?),
        ),
      ),
      GoRoute(
